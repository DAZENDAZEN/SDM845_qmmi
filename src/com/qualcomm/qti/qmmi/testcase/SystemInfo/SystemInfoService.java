...
public class SystemInfoService extends BaseService {
    ...
    public int run(TestCase testCase) {
		...
		String softVersion = Build.VERSION.INCREMENTAL;
        ...
        sb.append(resources.getString(R.string.systemInfo_version)).append(getSystemVersion()).append("\n")
                ...
                .append(resources.getString(R.string.systemInfo_softVersion)).append(softVersion).append("\n");
        ...
        testCase.addTestData("softversion", softVersion);
