...
public class KeyActivity extends BaseActivity {
...

    {
		...
		mKeyMap.put(KeyEvent.KEYCODE_DPAD_CENTER,"ok");
		mKeyMap.put(KeyEvent.KEYCODE_SWITCH_KEY,"switchkey");
		mKeyMap.put(KeyEvent.KEYCODE_SWITCH_KEY_BACKUP,"switchkeybackup");
        ...
        switch (event.getKeyCode()) {
         ...
         /*   case KeyEvent.KEYCODE_MENU:
            ...
            case KeyEvent.KEYCODE_DPAD_CENTER:
                keyText = (TextView) findViewById(R.id.ok);
                break;
			case KeyEvent.KEYCODE_SWITCH_KEY:
                keyText = (TextView) findViewById(R.id.switchkey);
                break;
			case KeyEvent.KEYCODE_SWITCH_KEY_BACKUP:
                keyText = (TextView) findViewById(R.id.switchkeybackup);
                break;
        }
